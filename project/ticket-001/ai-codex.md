...
This repository owns Git state transitions only. Model output is a typed AST
with enums and opaque references; a trusted controller resolves concrete paths,
Git arguments, evidence and effects. The first local commit is a special seed
transaction and must contain no standard implementation.
