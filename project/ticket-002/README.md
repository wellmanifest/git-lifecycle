...
Git repository contract. Publish the exact local state graph in
`standard/git-lifecycle.lifecycle`, validate it with the shared standalone validator,
...
- [x] AC-03: Domain conformance proves exact state and transition equality
  between the profile and the owning Git repository contract.
